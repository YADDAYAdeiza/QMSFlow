...
export default async function LedgerPage({
  ...
  // Fetching data for the form - ensuring institutional capacity and audit readiness
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-8 text-slate-900">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Header Section: Now includes Master Data Enrollment */}
        <header className="mb-10 flex justify-between items-end">
          ...
          <div className="flex flex-col items-end gap-3">
            {/* INTEGRATED ENROLLMENT: Capturing Master Data for FPPs */}
            <CertificateEnrollment companies={companies} />
            ...
            <div className="hidden md:block text-right border-r-2 border-slate-200 pr-3">
               ...
               <span className="text-sm font-bold text-slate-700 italic">Divisional Deputy Director</span>
            </div>
          </div>
        </header>
