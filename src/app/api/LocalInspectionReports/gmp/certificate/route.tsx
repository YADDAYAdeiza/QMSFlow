...
//       activities: Array.isArray(payload.checklistSnapshot?.activities_carried_out) 
//         ? payload.checklistSnapshot.activities_carried_out 
//         : [],
//       signatoryName: "Divisional Deputy Director"
//     };

//     // 1. Render React-PDF component to buffer
//     const pdfBuffer = await renderToBuffer(<GMPCertificate data={pdfData} />);

//     // 2. Return response with appropriate download headers
